...
\begin{figure}[H]
    ...
    \caption{CH$_3$OCHO Case 6 (\textbf{baseline model, before fixes}): $T_0=900$~K, $P=10$~atm, $\phi=1.0$. Ignition delay error: 165.2\%. This historical failure motivated the Revision~2 investigation and is \textbf{resolved by the final model} (0.7\% error, Figure~\ref{fig:final_t900}).}
