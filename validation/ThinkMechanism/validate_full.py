...
CASES = [
    ("CH3OCHO_T850_P10",       850, 10.0, 1.0, 0.2),
    ("CH3OCHO_T950_P10",       950, 10.0, 1.0, 0.08),
    ("CH3OCHO_T900_P15",       900, 15.0, 1.0, 0.15),
    ("CH3OCHO_T900_P5",        900,  5.0, 1.0, 0.08),
    ("CH3OCHO_T750_P20",       750, 20.0, 1.0, 1.0),
    ("CH3OCHO_T1100_P5",      1100,  5.0, 1.0, 0.05),
    ("CH3OCHO_T1300_P2",      1300,  2.0, 1.0, 0.01),
    ("CH3OCHO_T800_P5",        800,  5.0, 1.0, 0.3),
    ("CH3OCHO_T1100_P10_rich",1100, 10.0, 1.3, 0.08),
