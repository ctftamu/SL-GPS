...
4. Install networkx (for parallel compute) - `pip install networkx`
5. Install scikit - `pip install scikit-learn`
6. Install the SL-GPS library - `pip install "git+https://github.com/ctftamu/SL-GPS.git"`
